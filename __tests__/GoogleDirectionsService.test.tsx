...
describe("getOutdoorRoute", () => {
  ...
  /**
   * Google official sample polyline
   * decodes to:
   * [
  ...
  it("calls Google Directions API with correct URL", async () => {
    ...
    expect(calledUrl).toContain("https://maps.googleapis.com/maps/api/directions/json");
    expect(calledUrl).toContain(`origin=${origin.latitude},${origin.longitude}`);
