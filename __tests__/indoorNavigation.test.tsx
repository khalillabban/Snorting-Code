  ...
  beforeEach(() => {
    ...
    mockedFindShortestPath.mockReturnValue({
      steps: [
        ...
        { node: { id: "hall-1", x: 40, y: 10, floor: 1, type: "hallway", label: "Elev Lobby", accessible: true }, cumulativeDistance: 20 },
        { node: { id: "hall-2", x: 40, y: 10, floor: 2, type: "hallway", label: "Elev Lobby", accessible: true }, cumulativeDistance: 20 },
